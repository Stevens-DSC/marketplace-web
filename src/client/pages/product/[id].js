    ...
    return (
        <>
                ...
                <div style={styles.contentBox}>
                    ...
                    <div style={styles.priceContainer}>
                        ...
                        <span style={styles.fromSection}>
                            ...
                            <a target="_blank" style={styles.sellerNameLink} href={sellerInfo.homepage}>{sellerName}</a>
                        </span>
                     </div>
            ...
            <div style={styles.sellerInfo}>
                <div style={styles.sellerInfoTitle}>Seller Information</div>
                <p style={styles.sellerInfoProperty}><div style={styles.sellerInfoPropertyName}>Homepage</div>: <a target="_blank" href={sellerInfo.homepage}>{sellerName}</a></p>
                <p style={styles.sellerInfoProperty}><div style={styles.sellerInfoPropertyName}>Phone Number</div>: {formatPhone(sellerInfo.phone)}</p>
                <p style={styles.sellerInfoProperty}><div style={styles.sellerInfoPropertyName}>Email</div>: <a href={"mailto:" + sellerInfo.email.toLowerCase()}>{sellerInfo.email.toLowerCase()}</a></p>
                <a target="_blank" href={sellerInfo['maps-link']}>Google Maps</a>
            </div>
        </>
    );
}
...
function formatPhone(p) {
    return `(${p.slice(1,4)}) ${p.slice(4,7)}-${p.slice(7)}`;
}
